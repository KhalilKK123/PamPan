...
> **Repository state:** `PAMPAN-NATIVE-REWRITE` / I2A is **approved / active** for a minimal offline pantry contract preview; it is not yet implemented or verified. I1E and the larger Android foundation I1 remain **complete / PASS** only for exact state `I1E@660a5e39619d036d6b9228a97a18b2e036c44afd/tree-bcfdba270ae6938528de1af63f06244aec9331dc/run-30023752408/protected-82e0e3377b9f302b853ed7c5f3e0d1b0dc4cb5af269a628b5224722f775fb923` under the approved revised static-only CI policy. Hosted-emulator acceptance remains withdrawn/superseded, never retroactively passed. I1C remains **failed / BLOCKED historical evidence**, and I1D remains **complete / PASS for Diagnostic PASS only**. The full rewrite is not complete: Android remains the only active native application, `apps/ios/` is dormant, `pam_pan/` remains unchanged from `0512f84`, and the I2 remainder and I3–I9 remain inactive pending fresh approval.
>
...
- Active I2A plan: [offline pantry contract preview](docs/planning/active/pampan-native-rewrite-i2a.html)
